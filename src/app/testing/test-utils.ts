...
export class TestUtils {
  ...
  /**
   * Creates a mock SqljsService to avoid WebAssembly initialization issues during testing
   */
  static createMockSqlJsService() {
    ...
    return {
      ...
      getTechnologiesProcesses: jasmine.createSpy('getTechnologiesProcesses').and.returnValue(Promise.resolve(mockData.mockTechnologiesProcesses)),
      addTechnologyProcess: jasmine.createSpy('addTechnologyProcess').and.returnValue(Promise.resolve()),
      removeTechnologyProcess: jasmine.createSpy('removeTechnologyProcess').and.returnValue(Promise.resolve()),
      editTechnologyProcess: jasmine.createSpy('editTechnologyProcess').and.returnValue(Promise.resolve()),
      ...
      resetMockData: () => {
        const freshData = TestUtils.createMockData();
